...
# Modifier: Yuya Nagamatsu <nagamatsu@jsk.imi.i.u-tokyo.ac.jp>
...
"""
    ...
    def image_callback(self, msg):
        ...
        img_gray_recolor = cv2.cvtColor(img_gray, cv2.cv.CV_GRAY2BGR)

        # 12. publish debug image
        pub_debug_img_msg = self.bridge.cv2_to_imgmsg(img_gray_recolor, encoding="bgr8")
...
if __name__ == '__main__':
    ...
    rospy.init_node("image_processor_48156529")
